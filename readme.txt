...
#Скрипт заносит в массив, доступные пароли / логины из файлы data.txt
...
#При успешной паре после переадресации, в структуре документа html, не будет найдено значения переменной h_text.
...
#в gui скрипта вводим прямой путь : пример - 127.0.0.1/testing_form/login.php
